...
fnam = 'RATOWNIK'
lpp,brth,t,cb,cm,KG,tw = [86.56,18.8,5.0,0.754,0.971,7.261,11.89]
lbk,bbk = [26,.534]
...
for vs in VS:
    ...
    b44d = bfd + bwd + bed + bld + bbkd

    b44  = b44d*rho*cb*brth**3*t*lpp*np.sqrt(2*G/brth)

    print(b44)

    #ax.scatter(phi,b44d,label='%5.1fknt'%vs)
    ax.plot(phi,b44d,label='%5.1fknt'%vs)
